...
class ScreenWatcher(private val context: Context, private val agentCore: com.openjarvis.agent.AgentCore) {
    ...
    private fun getCurrentPackage(): String =
        JarvisAccessibilityService.instance?.getCurrentPackageName().orEmpty()
    ...
    private fun createNotificationChannel() {
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            ...
            manager.createNotificationChannel(
                android.app.NotificationChannel("watch_channel", "Jarvis Watch", android.app.NotificationManager.IMPORTANCE_LOW)
            )
        }
    }
